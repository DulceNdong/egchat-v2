...
const s = StyleSheet.create({
  ...
  topBtnText: { color: 'rgba(255,255,255,0.9)', fontSize: 13, fontWeight: '500' },
  ...
  localPip: {
    ...
    borderWidth: 2, borderColor: 'rgba(255,255,255,0.35)', backgroundColor: '#222',
  ...
  centerBlock: {
    ...
    zIndex: 5, paddingHorizontal: 24, paddingTop: 80,
  },
  bigAvatarWrap: { alignItems: 'center', justifyContent: 'center', marginBottom: 20 },
  bigAvatarRing: {
    width: 116, height: 116, borderRadius: 58,
    borderWidth: 3, borderColor: 'rgba(0,200,160,0.5)',
  ...
  bigName: { fontSize: 28, fontWeight: '700', color: '#fff', marginBottom: 8, textShadowColor: 'rgba(0,0,0,0.5)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  ...
  statusText: { fontSize: 15, color: 'rgba(255,255,255,0.75)' },
  callTypeLabel: { fontSize: 14, color: 'rgba(255,255,255,0.45)', marginTop: 2 },
  ...
  ctrlItem: { alignItems: 'center', gap: 6, minWidth: 60 },
  ctrlLabel: { color: 'rgba(255,255,255,0.75)', fontSize: 11, fontWeight: '500', textAlign: 'center' },
  ctrlBtn: {
  ...
  filterChipActive: { backgroundColor: 'rgba(0,200,160,0.4)', borderColor: ACCENT },
  ...
  incomingCard: {
    width: 290, borderRadius: 26, paddingVertical: 36, paddingHorizontal: 28,
    alignItems: 'center',
    shadowColor: '#000', shadowOffset: { width: 0, height: 20 }, shadowOpacity: 0.5, shadowRadius: 30, elevation: 24,
  },
  incomingAvatarRing: {
    ...
    alignItems: 'center', justifyContent: 'center',
    shadowColor: ACCENT, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.35, shadowRadius: 14,
  },
  incomingName: { fontSize: 22, fontWeight: '800', color: '#fff', marginBottom: 4 },
  ...
  incomingDots: { flexDirection: 'row', gap: 4, marginBottom: 28, marginTop: 10 },
  ...
  rejectBtn: {
    ...
    alignItems: 'center', justifyContent: 'center',
    shadowColor: '#ef4444', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.45, shadowRadius: 10, elevation: 10,
  },
  acceptBtn: {
    width: 68, height: 68, borderRadius: 34, backgroundColor: '#22c55e',
    alignItems: 'center', justifyContent: 'center',
    shadowColor: '#22c55e', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.45, shadowRadius: 10, elevation: 10,
  },
  incomingActionLabel: { fontSize: 13, color: 'rgba(255,255,255,0.6)', fontWeight: '500' },

  // ── Chat panel en llamada ─────────────────────────────────────────
  chatPanel: {
  ...
  chatList: { flex: 1 },
  chatEmpty: { color: 'rgba(255,255,255,0.35)', fontSize: 13, textAlign: 'center', marginTop: 24 },
  chatBubble: {
    maxWidth: '80%', borderRadius: 16, padding: 10, paddingHorizontal: 14,
  },
  chatBubbleMine: {
  ...
  chatBubbleText: { color: 'rgba(255,255,255,0.9)', fontSize: 14 },
  chatBubbleTime: { color: 'rgba(255,255,255,0.4)', fontSize: 10, marginTop: 3, alignSelf: 'flex-end' },
  chatInputRow: {
  ...
  chatInput: {
    flex: 1, color: '#fff', fontSize: 14, maxHeight: 80,
