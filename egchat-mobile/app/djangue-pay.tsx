...
const s = StyleSheet.create({
  ...
  amountLabel: { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
  amountValue: { fontSize: 38, fontWeight: '900', color: '#fff', marginVertical: 4 },
  amountSub: { fontSize: 13, color: 'rgba(255,255,255,0.6)' },
  balanceCard: {
  ...
  balanceCardLow: { borderColor: '#fecaca', backgroundColor: '#fef2f2' },
  balanceLabel: { fontSize: 11, color: '#94a3b8', marginBottom: 4, fontWeight: '600' },
  balanceValue: { fontSize: 22, fontWeight: '900', color: '#10b981' },
  suffBadge: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#dcfce7', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6 },
  suffTxt: { fontSize: 12, fontWeight: '700', color: '#15803d' },
  ...
  progressCount: { fontSize: 12, fontWeight: '700', color: '#10b981' },
  progressBg: { height: 7, backgroundColor: '#f1f5f9', borderRadius: 4, overflow: 'hidden' },
  progressFill: { height: 7, backgroundColor: '#10b981', borderRadius: 4, minWidth: 7 },
  progressGoal: { fontSize: 11, color: '#94a3b8' },
  payBtn: {
    paddingVertical: 16, alignItems: 'center', borderRadius: 14, marginTop: 4,
  ...
  successTitle: { fontSize: 26, fontWeight: '900', color: '#1e293b', marginTop: 8 },
  successAmount: { fontSize: 34, fontWeight: '900', color: '#10b981' },
  successSub: { fontSize: 14, color: '#64748b' },
  successBalance: { fontSize: 13, color: '#94a3b8', marginTop: 4 },
