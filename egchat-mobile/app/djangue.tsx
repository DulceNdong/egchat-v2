...
const s = StyleSheet.create({
  ...
  createBtnGrad: { paddingHorizontal: 28, paddingVertical: 13, backgroundColor: '#6366f1', borderRadius: 12 },
  createBtnTxt: { fontSize: 15, fontWeight: '700', color: '#fff' },
  list: { padding: 16, gap: 12 },
  newBtn: { marginBottom: 4, borderRadius: 12, overflow: 'hidden' },
  newBtnGrad: { paddingVertical: 13, alignItems: 'center', backgroundColor: '#6366f1', borderRadius: 12 },
  newBtnTxt: { fontSize: 15, fontWeight: '700', color: '#fff' },
});

const c = StyleSheet.create({
  card: { backgroundColor: '#fff', borderRadius: 16, padding: 16, gap: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 2 },
  ...
  progressTxt: { fontSize: 11, color: '#94a3b8', fontWeight: '500' },
  progressBg: { height: 5, backgroundColor: '#f1f5f9', borderRadius: 3, overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: 3, minWidth: 5 },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#f1f5f9', paddingTop: 10, marginTop: 2 },
  footerItem: { alignItems: 'center', flex: 1 },
  footerLabel: { fontSize: 10, color: '#94a3b8', marginBottom: 2, textTransform: 'uppercase', fontWeight: '600' },
  footerValue: { fontSize: 13, fontWeight: '800', color: '#1e293b' },
  myTurnBadge: { borderRadius: 10, paddingVertical: 7, alignItems: 'center' },
  myTurnTxt: { fontSize: 13, fontWeight: '800', color: '#fff' },
  unpaidBadge: { backgroundColor: '#fef9c3', borderRadius: 10, paddingVertical: 7, alignItems: 'center', borderWidth: 1, borderColor: '#fde68a' },
  unpaidTxt: { fontSize: 12, color: '#d97706', fontWeight: '700' },
});
