...
const s = StyleSheet.create({
  ...
  loadingTxt: { color: '#94a3b8', fontSize: 14, marginTop: 16 },
  errorTxt: { color: '#ef4444', fontSize: 14, textAlign: 'center', paddingHorizontal: 32 },
  linkTxt: { color: '#6366f1', fontWeight: '700', fontSize: 14 },
  header: {
  ...
  headerTitle: { fontSize: 16, fontWeight: '800', color: '#1e293b', textAlign: 'center' },
  headerSub: { fontSize: 11, color: '#94a3b8', marginTop: 1, textAlign: 'center' },
  card: { backgroundColor: '#fff', borderRadius: 14, padding: 16, gap: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 1 },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  cardLabel: { fontSize: 11, fontWeight: '700', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.5 },
  turnCircle: { width: 76, height: 76, borderRadius: 38, backgroundColor: '#f0f1fe', borderWidth: 2.5, borderColor: '#6366f1', alignItems: 'center', justifyContent: 'center' },
  turnNumber: { fontSize: 32, fontWeight: '900', color: '#6366f1' },
  turnLabel: { fontSize: 12, color: '#94a3b8', marginTop: 6 },
  turnInfo: { fontSize: 14, fontWeight: '600', color: '#1e293b', textAlign: 'center' },
  turnDate: { fontSize: 11, color: '#94a3b8', textAlign: 'center', marginTop: 3 },
  highlightBanner: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#fef9c3', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: '#fde68a' },
  highlightEmoji: { fontSize: 28 },
  highlightTitle: { fontSize: 14, fontWeight: '800', color: '#d97706' },
  highlightSub: { fontSize: 12, color: '#92400e', marginTop: 2, lineHeight: 16 },
  paidStatus: { alignItems: 'center', paddingVertical: 6 },
  paidTitle: { fontSize: 15, fontWeight: '800', color: '#10b981', marginTop: 6 },
  paidAmount: { fontSize: 18, fontWeight: '900', color: '#1e293b', marginTop: 3 },
  owedBox: { backgroundColor: '#fef9c3', borderRadius: 12, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: '#fde68a' },
  owedLabel: { fontSize: 11, color: '#92400e', fontWeight: '600' },
  owedAmount: { fontSize: 22, fontWeight: '900', color: '#d97706', marginTop: 3 },
  payBtn: { borderRadius: 12, paddingVertical: 13, alignItems: 'center', marginTop: 3, backgroundColor: '#6366f1', shadowColor: '#6366f1', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 3 },
  payBtnTxt: { fontSize: 15, fontWeight: '800', color: '#fff' },
  justifyBtn: { borderWidth: 1, borderColor: '#c7d2fe', borderRadius: 12, paddingVertical: 11, alignItems: 'center', backgroundColor: '#f0f1fe' },
  justifyTxt: { fontSize: 13, fontWeight: '600', color: '#6366f1' },
  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  statBox: { flex: 1, minWidth: (width - 32 - 16 - 8) / 2, backgroundColor: '#f8fafc', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: '#e2e8f0', alignItems: 'center' },
  statValue: { fontSize: 17, fontWeight: '900', color: '#1e293b' },
  statLabel: { fontSize: 11, color: '#94a3b8', marginTop: 3, textAlign: 'center' },
  penaltyWarning: { backgroundColor: '#fef2f2', borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#fecaca', marginTop: 4 },
  penaltyTxt: { fontSize: 13, fontWeight: '600', color: '#ef4444', textAlign: 'center' },
  chatFab: { position: 'absolute', bottom: 20, right: 20, width: 56, height: 56, borderRadius: 28, shadowColor: '#6366f1', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 8 },
});
...
const h = StyleSheet.create({
  ...
  iconBox: { width: 34, height: 34, borderRadius: 17, backgroundColor: '#f0fdf4', alignItems: 'center', justifyContent: 'center' },
  info: { flex: 1 },
