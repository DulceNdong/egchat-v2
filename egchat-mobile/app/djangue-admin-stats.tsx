...
const s = StyleSheet.create({
  ...
  loadingTxt: { color: '#94a3b8', fontSize: 14, marginTop: 8 },
  ...
  metricCard: { flex: 1, minWidth: (width - 32 - 10) / 2, borderRadius: 14, padding: 14, gap: 6, borderWidth: 1 },
  metricValue: { fontSize: 16, fontWeight: '900', color: '#1e293b' },
  metricLabel: { fontSize: 11, color: '#64748b', fontWeight: '600' },
  card: { backgroundColor: '#fff', borderRadius: 14, padding: 14, gap: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 1 },
  ...
  progressBg: { height: 7, backgroundColor: '#f1f5f9', borderRadius: 4, overflow: 'hidden', marginTop: 4 },
  progressFill: { height: 7, borderRadius: 4, minWidth: 7 },
  complianceCircle: { width: 90, height: 90, borderRadius: 45, borderWidth: 6, alignItems: 'center', justifyContent: 'center' },
  complianceValue: { fontSize: 24, fontWeight: '900' },
  ...
  complianceStatTxt: { fontSize: 12, color: '#64748b', fontWeight: '500' },
});
