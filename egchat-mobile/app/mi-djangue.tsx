...
const s = StyleSheet.create({
  ...
  brandName: { fontSize: 18, fontWeight: '900', color: '#fff', letterSpacing: 1, marginTop: 8 },
  divider: { width: 36, height: 2.5, backgroundColor: '#fff', marginVertical: 6, borderRadius: 2 },
  productName: { fontSize: 26, fontWeight: '900', color: '#fff', letterSpacing: 0.5 },
  illustrationContainer: { alignItems: 'center', paddingVertical: 10 },
  illustration: {
    width: 160,
    height: 160,
    borderRadius: 80,
  ...
  textContainer: { alignItems: 'center', paddingHorizontal: 28, marginBottom: 16 },
  title: { fontSize: 24, fontWeight: '900', color: '#fff', marginBottom: 6, textAlign: 'center', letterSpacing: 0.5 },
  subtitle: { fontSize: 14, fontWeight: '600', color: 'rgba(255,255,255,0.9)', textAlign: 'center', lineHeight: 20 },
  homeButtons: { paddingHorizontal: 20, gap: 10, marginBottom: 16 },
  primaryButton: {
    borderRadius: 16,
    overflow: 'hidden',
    shadowColor: '#000',
  ...
  primaryButtonText: { fontSize: 16, fontWeight: '900', color: '#00C8A0', letterSpacing: 0.3 },
  secondaryButton: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  secondaryButtonText: { fontSize: 15, fontWeight: '800', color: '#fff', letterSpacing: 0.3 },
  features: { flexDirection: 'row', justifyContent: 'center', gap: 24, paddingBottom: 16 },
  featureRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  featureText: { fontSize: 12, color: 'rgba(255,255,255,0.85)', fontWeight: '600' },
