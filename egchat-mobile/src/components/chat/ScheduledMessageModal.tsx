...
import {
  ...
  TouchableOpacity, Platform, Alert, useColorScheme,
} from 'react-native';
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose} statusBarTranslucent>
      <Pressable style={s.overlay} onPress={onClose}>
        <Pressable style={[s.sheet, { backgroundColor: sheetBg }]} onPress={e => e.stopPropagation()}>
          ...
          <TouchableOpacity style={[s.timeBtn, { backgroundColor: isDark ? 'rgba(0,180,230,0.15)' : 'rgba(0,180,230,0.08)' }]} onPress={() => setShowPicker(true)} activeOpacity={0.7}>
...
const s = StyleSheet.create({
  ...
  title: { fontSize: 17, fontWeight: '700', textAlign: 'center', marginBottom: 10 },
  preview: { borderRadius: 10, padding: 12, fontSize: 14, marginBottom: 16 },
  timeBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, marginBottom: 8 },
