    ...
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: '400px', padding: '24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <div style={{ fontSize: '13px', color: '#64748b', marginTop: '4px' }}>Portal de administraciÃ³n</div>
        </div>
        ...
        <div style={{ background: '#1e293b', borderRadius: '16px', padding: '24px', border: '1px solid #334155' }}>
          ...
          {serverStatus === 'sleeping' && (
            <div style={{ background: 'rgba(234,179,8,0.1)', border: '1px solid rgba(234,179,8,0.3)', borderRadius: '8px', padding: '8px 12px', color: '#eab308', fontSize: '12px', marginBottom: '16px', textAlign: 'center' }}>
              âš¡ Servidor iniciando (free tier) â€” espera ~30 segundos antes de entrar
            </div>
          )}
          {serverStatus === 'ok' && (
          ...
          {!requireTotp ? (
            <form onSubmit={handleLogin}>
              ...
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: '#94a3b8', marginBottom: '6px' }}>ContraseÃ±a</label>
                <input type="password" value={password} onChange={e => setPassword(e.target.value)} required
                  placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"
                  style={{ width: '100%', background: '#0f172a', border: '1.5px solid #334155', borderRadius: '8px', padding: '10px 12px', color: '#f1f5f9', fontSize: '14px', outline: 'none', boxSizing: 'border-box' }} />
              </div>
              {error && <div style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: '8px', padding: '10px', color: '#ef4444', fontSize: '13px', marginBottom: '16px' }}>âš ï¸ {error}</div>}
            ...
            <form onSubmit={handleTotp}>
              <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                ...
                <div style={{ fontSize: '14px', fontWeight: '700', color: '#f1f5f9' }}>VerificaciÃ³n 2FA</div>
                <div style={{ fontSize: '12px', color: '#64748b', marginTop: '4px' }}>Introduce el cÃ³digo de tu app autenticadora</div>
              </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '16px', fontSize: '11px', color: '#475569' }}>EGCHAT Admin Portal v1.0 â€” Guinea Ecuatorial</div>
      </div>
    </div>
  );
};
