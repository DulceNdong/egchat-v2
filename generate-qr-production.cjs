...
const urls = {
  ...
  download: 'https://egchat-app.vercel.app/download'
};
...
<body>
    <div class="container">
        ...
        <p class="subtitle">Aplicación web en producción - Conectando Guinea Ecuatorial</p>
        
        <div class="status">
            <div class="status-text">🟢 EN PRODUCCIÓN</div>
            <div>Frontend y Backend activos</div>
        </div>
        ...
        <div class="buttons">
            ...
            <button onclick="window.print()" class="btn btn-secondary">🖨️ Imprimir QR</button>
        </div>
        <div class="footer">
            EGCHAT - Conectando Guinea Ecuatorial<br>
            📱 PWA • 🌐 Web • 🖥️ Desktop • 🚀 Producción
        </div>
    </div>
</body>
</html>`;
...
// Generar QR principal de producción
async function generateProductionQR() {
  console.log('🎯 Generando QR de Producción para EGCHAT...\n');
  
  await generateQRCode(
    urls.frontend, 
    'EGCHAT-Producción', 
    'EGCHAT - Aplicación Web en Producción'
  );
  
  console.log('\n🚀 ¡QR de producción generado exitosamente!');
  console.log('\n📋 Para usar:');
  console.log('  1. Abre EGCHAT-Producción.html en tu navegador');
  console.log('  2. Escanea el QR con tu teléfono móvil');
  console.log('  3. Accede instantáneamente a EGCHAT en producción');
  console.log('\n🌐 URL directa: ' + urls.frontend);
  console.log('\n🔗 Backend API: ' + urls.backend);
}

// Ejecutar
generateProductionQR();
