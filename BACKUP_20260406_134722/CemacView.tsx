...
export const CemacView: React.FC<{ onBack?: ()=>void }> = ({ onBack }) => {
    ...
    >
      ...
      {onBack && (
        <div style={{ padding:'10px 16px 0', flexShrink:0 }}>
          <button onClick={onBack} style={{ background:'rgba(255,255,255,0.18)', border:'1px solid rgba(255,255,255,0.3)', borderRadius:'50%', width:36, height:36, display:'flex', alignItems:'center', justifyContent:'center', cursor:'pointer' }}>
  ...
  if (mapAtm) return (
    <div style={{ width:'100%', height:'100%', background:'#F0F2F5', display:'flex', flexDirection:'column', paddingTop:56, boxSizing:'border-box' }}>
      <div style={{ background:grad, padding:'12px 16px', display:'flex', alignItems:'center', gap:12, flexShrink:0 }}>
        <button onClick={() => setMapAtm(null)} style={{ background:'rgba(255,255,255,0.2)', border:'none', borderRadius:10, width:36, height:36, display:'flex', alignItems:'center', justifyContent:'center', cursor:'pointer', color:'#fff', fontSize:20 }}><svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='#fff' strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round'><polyline points='15 18 9 12 15 6'/></svg></button>
  ...
  return (
    <div style={{ width:'100%', height:'100%', background:'#F0F2F5', display:'flex', flexDirection:'column', overflow:'hidden', paddingTop:56, boxSizing:'border-box' }}>
      ...
      {/* HEADER */}
      <div style={{ background:grad, flexShrink:0, boxShadow:'0 2px 16px rgba(0,0,0,0.18)' }}>
        <div style={{ display:'flex', alignItems:'center', gap:10, padding:'12px 16px 10px' }}>
          <button onClick={() => setCountry(null)}
            ...
            onMouseLeave={e => { e.currentTarget.style.background='rgba(255,255,255,0.2)'; e.currentTarget.style.transform='scale(1)'; }}><svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='#fff' strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round'><polyline points='15 18 9 12 15 6'/></svg></button>
          <div style={{ flex:1 }}>
        ...
        <div style={{ display:'flex', overflowX:'auto', scrollbarWidth:'none', padding:'0 10px', gap:2 }}>
          {TABS.map(tb => (
            <button key={tb.id} onClick={() => setTab(tb.id)}
              style={{ flexShrink:0, background:tab===tb.id?'rgba(255,255,255,0.95)':'transparent', border:'none', borderRadius:'12px 12px 0 0', padding:'8px 13px', color:tab===tb.id?g1:'rgba(255,255,255,0.85)', fontWeight:tab===tb.id?700:500, fontSize:12, cursor:'pointer', whiteSpace:'nowrap', transition:'all 0.2s', outline:'none' }}
