      ...
      <div style={{flex:1,overflowY:'auto'}}>
        ...
        <div style={{background:'#fff',padding:'28px 16px 20px',textAlign:'center',marginBottom:'8px'}}>
          <div style={{position:'relative',display:'inline-block',marginBottom:'14px'}}>
            <div style={{width:'90px',height:'90px',borderRadius:'50%',background:`${cpColor}20`,display:'flex',alignItems:'center',justifyContent:'center',fontSize:'32px',fontWeight:'800',color:cpColor,margin:'0 auto'}}>
              {cpInitials}
            </div>
            {cp.status==='online'&&(
              <div style={{position:'absolute',bottom:'4px',right:'4px',width:'16px',height:'16px',borderRadius:'50%',background:'#22c55e',border:'2.5px solid #fff'}}/>
            )}
          </div>
