          ...
          <div>
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'10px',marginBottom:'12px'}}>
              {[
                ...
                <button key={game.id} onClick={()=>{setCsel({id:game.id,name:game.name,icon:game.icon,provider:'EGCHAT',rtp:'97%',type:'crash'});setCamt('500');setCres(null);}}
                  style={{background:`linear-gradient(135deg,${game.color} 0%,${game.color}dd 100%)`,border:'none',borderRadius:'12px',padding:'16px',cursor:'pointer',transition:'all 0.3s',transform:'scale(1)',boxShadow:'0 4px 15px rgba(0,0,0,0.2)',color:'#fff',textAlign:'center'}}>
