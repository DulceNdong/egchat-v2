      ...
      case 'ajustes':
        return (
          ...
          <ConfiguracionView
            ...
            MESSAGE_TONES={MESSAGE_TONES}
            RINGTONES={RINGTONES}
            NOTIFICATION_TONES={NOTIFICATION_TONES}
            customTones={customTones}
            saveCustomTones={saveCustomTones}
            ...
            walletPIN={walletPIN}
            setShowSetupPIN={setShowSetupPIN}
            showToast={showToast}
            setCurrentView={setCurrentView}
            authAPI={authAPI}
            removePushListeners={removePushListeners}
            cleanupCallManager={cleanupCallManager}
            setIsAuthenticated={setIsAuthenticated}
            setRealChats={setRealChats}
